...
This is trimmed for readability; the remaining offers follow the same shape:
{
  "PURCHASE_HISTORY_LIMIT": 120,
  "PROCESSED_RECEIPT_LIMIT": 180,
  "REFUND_NOTE_LIMIT": 140,
  "EntitlementIds": ["FootyenGain10x", "MovementSpeed5x", "TripleSummon", "ExtraEquipTwo", "LuckySummon", "BootMagnet", "PetPassiveAura"],
  "StackableIds": ["ExtraPetSlots", "PetPassiveOverclock", "BootValueCore"],
  "Entitlements": {
    "FootyenGain10x": { "displayName": "Permanent x10 Footyen Gain" },
    "MovementSpeed5x": { "displayName": "Permanent x5 Movement Speed" },
    "TripleSummon": { "displayName": "3x Summon Unlock" },
    "ExtraEquipTwo": { "displayName": "+2 Equipped Pets" },
    "LuckySummon": {
      "displayName": "Lucky Summon Chance",
      "luckyWeightMultipliers": { "Common": 0.82, "Uncommon": 1.15, "Rare": 1.75, "Legendary": 2.8 }
    }
  },
  "Stackables": {
    "ExtraPetSlots": { "displayName": "+5 Pet Slots", "grantAmount": 1, "slotIncreasePerStack": 5 },
    "PetPassiveOverclock": { "displayName": "Pet Passive Overclock", "grantAmount": 1, "passiveMultiplierPerStack": 0.15 },
    "BootValueCore": { "displayName": "Boot Value Core", "grantAmount": 1, "bootValueMultiplierPerStack": 0.12 }
  },
  "OfferCategories": {
    "Footgems": "Footgems",
  ...
  "Offers": {
    ...
    "GalacticCompanionBundle": {
      ...
      "bundle": {
        "footgems": 8000,
        "pets": [{ "petId": "Galactic", "level": 1 }],
        "entitlements": ["ExtraEquipTwo"]
      }
    }
  }
}
...
ShopConfig.Live = LiveConfig.attachModule(ShopConfig, {
	key = "ShopConfig",
})
